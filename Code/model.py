...
class KGEModel(nn.Module):
    def __init__(self, model_name, nentity, nrelation, hidden_dim, gamma, 
        ...
        self.is_relate_family = model_name in {'RelatE', 'CCRelatE', 'BKRelatE', 'ARelatE'}
        ...
        if model_name not in ['TransE', 'DistMult', 'ComplEx', 'RotatE', 'pRotatE', 'RelatE', 'CCRelatE', 'BKRelatE', 'ARelatE', 'CCMuRP', 'MuRP']:
    ...
    def forward(self, sample, mode='single', step=None):
        ...
        if self.model_name in {'RelatE', 'CCRelatE', 'BKRelatE', 'ARelatE', 'CCMuRP', 'MuRP'}:
            score = model_func[self.model_name](head, relation, tail, mode,
                                                head_ids=head_ids,
                                                tail_ids=tail_ids,
    ...
    def train_step(model, optimizer, train_iterator, args, step, path_batch=None,
        ...
        if base_model.model_name in {'RelatE', 'CCRelatE', 'BKRelatE', 'ARelatE', 'CCMuRP', 'MuRP'}:
            if step % 1000 == 0:
                logging.info(
