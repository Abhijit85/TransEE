...
CUDA_VISIBLE_DEVICES=$GPU_DEVICE python -u $CODE_PATH/driver.py --do_train \
    --cuda \
    --do_valid \
    --do_test \
...
CUDA_VISIBLE_DEVICES=$GPU_DEVICE python -u $CODE_PATH/driver.py --do_valid --cuda -init $SAVE
...
CUDA_VISIBLE_DEVICES=$GPU_DEVICE python -u $CODE_PATH/driver.py --do_test --cuda -init $SAVE
